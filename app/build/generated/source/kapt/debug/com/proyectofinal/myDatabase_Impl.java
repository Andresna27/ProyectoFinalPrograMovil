  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `To_Do` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `priority` TEXT NOT NULL, `dni` TEXT NOT NULL, `placa` TEXT NOT NULL, `name` TEXT NOT NULL, `phone` TEXT NOT NULL, `hora` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '79d992fddf24b2c74ae1572cf1811c69')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsToDo.put("dni", new TableInfo.Column("dni", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsToDo.put("placa", new TableInfo.Column("placa", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsToDo.put("name", new TableInfo.Column("name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsToDo.put("phone", new TableInfo.Column("phone", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsToDo.put("hora", new TableInfo.Column("hora", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoToDo.equals(_existingToDo)) {
          return new RoomOpenHelper.ValidationResult(false, "To_Do(com.proyectofinal.Entity).\n"
                  + " Expected:\n" + _infoToDo + "\n"
                  + " Found:\n" + _existingToDo);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "79d992fddf24b2c74ae1572cf1811c69", "8b26c8cbd4dab002f28f8803efd5f7fe");
